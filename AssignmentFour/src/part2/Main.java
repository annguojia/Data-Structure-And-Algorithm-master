...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// Traverse the MST returned from previous steps to find the path
			BruteForceChecker bfChecker = new BruteForceChecker(adjacencyMatrix);
			String resultString = bfChecker.check();
